...
function OpenClose(elementClass, SidebarItemsClass) {
    ...
    if (element.className === elementClass) {
        element.setAttribute(
            "src",
            "https://storage.iran.liara.space/rezashakeri/static/images/icons/findAndShowNextMatches.svg"
        );
        element.className += " open";
        sidebarItems.removeAttribute("style");
    } else {
        element.setAttribute("src", "https://storage.iran.liara.space/rezashakeri/static/images/icons/play_forward.svg");
